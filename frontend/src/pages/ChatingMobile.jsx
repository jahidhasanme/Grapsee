...
import styles from './styles/ChatingMobile.module.css'
...
const ChatingMobile = () => {
    ...
    const { user, chats, setMessageCounter, messageCounter } = useAppContext();
    ...
    return (<>
        <div className={styles.container} >
            ...
            <div style={{ width: '100%', display: 'flex', alignItems: 'center', borderBottom: '1px solid #CCCCCC', padding: '4px', paddingBottom: '8px' }}>
                ...
                <ProfilePic isActive={reciver.isActive} src={reciver.profile} alt='Profile' sx={{ width: '50px', height: '50px', borderRadius: '50%', marginLeft: '-10px', marginRight: '8px' }} />
